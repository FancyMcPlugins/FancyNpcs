...
import de.oliver.fancynpcs.v1_20_1.MappingKeys1_20_1;
...
public class PandaAttributes {
    ...
    private static void setFlag(Panda panda, int mask, boolean value) {
        EntityDataAccessor<Byte> DATA_ID_FLAGS = (EntityDataAccessor<Byte>) ReflectionUtils.getValue(panda, MappingKeys1_20_1.PANDA__DATA_ID_FLAGS.getMapping());
